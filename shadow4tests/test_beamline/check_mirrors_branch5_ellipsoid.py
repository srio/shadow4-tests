...
def run_ellipsoid(kind="ellipsoid"):
    #
    # shadow3
    #
    if kind == "ellipsoid":
        from shadow4tests.oasys_workspaces.mirrors_branch5_ellipsoid import define_source, run_source, define_beamline, run_beamline
    elif kind == "ellipsoid_tangential_cylinder":
        from shadow4tests.oasys_workspaces.mirrors_branch5_ellipsoid_tangential_cylinder import define_source, run_source, define_beamline, run_beamline
    else:
...
if __name__ == "__main__":
    ...
    run_ellipsoid("ellipsoid")
    run_ellipsoid("ellipsoid_tangential_cylinder")
