...
class OWRemoteGithubDownloader(oasyswidget.OWWidget):
    ...
    def __init__(self):
        ...
        box3 = gui.widgetBox(main_box, "Downloading options", orientation="vertical")
        ...
        oasysgui.lineEdit(box45, self, "github_token", "github token [not stored]", labelWidth=335,
                                             valueType=str, orientation="horizontal",
                                             )

        box46 = gui.widgetBox(box4, orientation="horizontal")
        button = gui.button(box46, self, "Upload...", callback=self.upload)
        button.setFixedHeight(35)
